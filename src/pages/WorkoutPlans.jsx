...
const WorkoutPlans = () => {
  ...
  const handleCompleteWorkout = async () => {
    ...
    if (completedNames.length === 0) {
      alert("Please mark at least one exercise as complete.");
      return;
    }
            ...
            {isExpanded && (
              <div className="p-6 space-y-4 bg-[#110d0d]">
                ...
                <button 
                  ...
                  className={`w-full mt-4 text-white p-5 rounded-2xl font-bold uppercase tracking-widest text-sm flex items-center justify-center gap-3 transition-all shadow-[0_4px_20px_rgba(239,68,68,0.25)] border border-red-400/30 ${
                    isSubmitting ? 'bg-red-800 cursor-not-allowed' : 'bg-red-500 hover:bg-red-600 hover:shadow-[0_4px_30px_rgba(239,68,68,0.4)]'
                  }`}
                >
